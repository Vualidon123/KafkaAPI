...
public interface IProduct_Update_Consumer_sub1
{
    Task ConsumeAsync(string topic, CancellationToken cancellationToken);
}


public class Product_Update_Consumer_sub1 : IProduct_Update_Consumer_sub1
{
    ...
    public Product_Update_Consumer_sub1(MongoDbContext context)
    {
        _context = context;
